...
namespace StockTrader.Main.VVM.ViewModels
{
    public class PortfolioViewModel : BaseViewModel
    {
        ...
        public PortfolioViewModel(AssetStore assetStore)
        {
            ...
            {
                new ComboBoxOption { Text = "Top", ImageSource = "/StockTrader.Main;component/Images/3icon.png" , Number = 3 },
                new ComboBoxOption { Text = "Top", ImageSource = "/StockTrader.Main;component/Images/10icon.png", Number = 10 },
                new ComboBoxOption { Text = "Top", ImageSource = "/StockTrader.Main;component/Images/100icon.png", Number = 100 },
                new ComboBoxOption { Text = "All  ", ImageSource = "/StockTrader.Main;component/Images/checkIcon.png", Number = -1 },
            };
